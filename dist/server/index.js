globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-D3MKlGHA.js","assets/layout-segment-context-DURVnsDi.js"];
...
function getDraftSecret() {
	return "ce352f6b-7d79-4dd5-a916-4fc3a123abde";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "576ea61b-3e32-4948-9b19-7d36f879c6ec";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "576ea61b-3e32-4948-9b19-7d36f879c6ec") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "576ea61b-3e32-4948-9b19-7d36f879c6ec",
		rootBoundaryId
	});
}
/**
...
var title = "DABU MATH";
var description = "수업 영상과 PDF 자료, 중요한 공지를 한곳에서 확인하는 DABU MATH 학생 사이트.";
var siteUrl = process.env.NEXT_PUBLIC_SITE_URL ?? "http://localhost:3000";
var ogImage = `${process.env.PAGES_BASE_PATH ?? ""}/og.png`;
var metadata = {
