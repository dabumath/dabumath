    ...
    announcements: [
      {
        id: "common2a-start",
        scope: "공통수학2 A반",
        title: "공통수학2 A반 페이지 안내",
        summary: "A반 전용 수업 영상과 자료를 확인하세요.",
        date: "2026-07-30",
        content: [
          "이 페이지에는 공통수학2 A반 자료만 표시됩니다.",
    ...
    announcements: [
      {
        id: "common2b-start",
        scope: "공통수학2 B반",
        title: "공통수학2 B반 페이지 안내",
        summary: "B반 전용 수업 영상과 자료를 확인하세요.",
        date: "2026-07-30",
        content: [
          "이 페이지에는 공통수학2 B반 자료만 표시됩니다.",
          "입장 코드는 다른 반 학생에게 공유하지 마세요.",
        ],
      },
    ],
    ...
    announcements: [
      {
        id: "calculus1b-start",
        scope: "미적분Ⅰ B반",
        title: "미적분Ⅰ B반 페이지 안내",
        summary: "B반 전용 수업 영상과 자료를 확인하세요.",
        date: "2026-07-30",
        content: [
          "이 페이지에는 미적분Ⅰ B반 자료만 표시됩니다.",
          "입장 코드는 다른 반 학생에게 공유하지 마세요.",
        ],
      },
    ],
